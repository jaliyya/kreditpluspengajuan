      ...
      <div class="pt-wrapper" style="background-image: url(../images/bg.png);">
        ...
        <div class="subpages">
          ...
          <section class="pt-page pt-page-5" data-id="contact">
            ...
            <button type="button" name="button" class="button" onclick="document.location.href='../'">Kembali</button>
            <div class="section-inner">
              <div class="section-title-block">
                <div class="section-title-wrapper">
                  <h2 class="section-title">Page Account</h2>
                  <h5 class="section-description">Login User</h5>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-md-6 subpage-block">
                  ...
                  <form id="contact-form" method="post" action="../user/process-login.php">
                    ...
                    <div class="controls">
                      ...
                      <button type="button" name="button" class="button btn-send" onclick="document.location.href='../user/register.php'">Belum Punya Akun</button>
                    </div>
                  </form>
                </div>
              </div>
