...
if (@$_POST['simpan']) {
  ...
  mysqli_query($connect, "INSERT INTO user(username,password,email,phone) VALUES ('$username', '$password','$email','$phone')");
?>
            ...
            <div class="section-inner">
              <div class="section-title-block">
                <div class="section-title-wrapper">
                  ...
                  <h5 class="section-description">Register User</h5>
                </div>
              </div>
                ...
                <div class="col-sm-6 col-md-6 subpage-block">
                  ...
                  <form id="contact-form" method="post" action="">
                    ...
                    <div class="controls">
                      ...
                      <div class="form-group">
                        <input id="form_email" type="email" name="email" class="form-control" placeholder="Email (examples@mail.co.id)" required="required" data-error="Email harus di isi.">
                      ...
                      <div class="form-group">
                        <input id="form_email" type="text" name="phone" class="form-control" placeholder="Nomor Telepon (+62 89 543 765 457)" required="required" data-error="Nomor Telepon harus di isi." onkeypress="return hanyaAngka(event)">
                      </div>
                      ...
                      <button type="button" name="button" class="button btn-send" onclick="document.location.href='login.php'">Sudah Punya Akun</button>
                    </div>
                  </form>
                </div>
