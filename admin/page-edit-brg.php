      ...
      <div class="pt-wrapper" style="background-image: url(../images/bg.png);">
        ...
        <div class="subpages">
          ...
          <section class="pt-page pt-page-5" data-id="contact">
            ...
            <button type="button" name="button" class="button" onclick="document.location.href='../admin/page-index2.php#barang'">Kembali</button>
            <div class="section-inner">
              <div class="section-inner">
                <div class="section-title-block">
                  <div class="section-title-wrapper">
                    <h2 class="section-title">Page Barang</h2>
                    <h5 class="section-description">Kredit Barang</h5>
                  </div>
                </div>
                    ...
                    <form id="contact-form" method="post" action="../admin/edit-brg.php">
                      <div class="controls">
                        ...
                        <div class="form-group">
                          <label>Nama Resmi Produk</label>
                          <input  type="text" name="np" class="form-control" value="<?php echo $data['nama_produk'] ?>">
                        </div>

                        <div class="form-group">
                          <label>Harga Produk</label>
                          <input  type="text" name="hrg" class="form-control" onkeypress="return hanyaAngka(event)" value="<?php echo $data['harga'] ?>">
                        </div>

                        <div class="form-group">
                          <label>Kode Barang</label>
                          <input type="text" name="kode_barang" class="form-control" value="<?php echo $data['kode_barang'] ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6 subpage-block">
                      ...
                      <div class="controls">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="stk" class="form-control" onkeypress="return hanyaAngka(event)" value="<?php echo $data['stok'] ?>">
                        </div>
                        <?php
                        $result = $connect->query("SELECT nama FROM kategori");
                        ?>
