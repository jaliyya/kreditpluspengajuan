      ...
      <div class="pt-wrapper" style="background-image: url(../images/bg.png);">
        ...
        <div class="subpages">
          ...
          <section class="pt-page pt-page-5" data-id="contact">
              ...
              <button type="button" name="button" class="button" onclick="document.location.href='../'">Kembali</button>            <div class="section-inner">
              <div class="section-title-block">
                <div class="section-title-wrapper">
                  <h2 class="section-title">Page Account</h2>
                  <h5 class="section-description">Login Admin</h5>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-6 col-md-6 subpage-block">
                  <div class="block-title">
                    ...
                    <h3><b>Selamat datang!</b> di Menu <i>Login</i></h3>
                    <p>Untuk dapat menikmati Layanan Kami,<br> silahkan Login terlebih dahulu, terimakasih.</p>

                    <ul>
                      <ol>
                        Username
                        <br>(Masukan Username yang sudah kamu buat sebelumnya)
                      </ol>
                      <ol>
                        Password
                        <br>(Masukan Password yang kamu buat sebelumnya)
                      </ol>
                    </ul>
                  </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6 subpage-block">
                  <div class="block-title">
                    <h3>Login Form Admin</h3>
                  </div>
                  <form id="contact-form" method="post" action="../admin/process-login.php">

                    <div class="messages"></div>

                    <div class="controls">
                      <div class="form-group">
                        <input id="form_name" type="text" name="username" class="form-control" placeholder="Username" required="required" data-error="Username is required.">

                      </div>

                      <div class="form-group">
                        <input id="form_email" type="password" name="password" class="form-control" placeholder="Password" required="required" data-error="Password is required.">

                      </div>

                      <input type="submit" class="button btn-send" value="Login">
                      <!-- <button type="button" name="button" class="button btn-send" onclick="document.location.href='../admin/register.php'">Belum Punya Akun</button> -->
                    </div>
                  </form>
                </div>
              </div>
