      ...
      <div class="pt-wrapper" style="background-image: url(../images/bg.png);">
        ...
        <div class="subpages">
          ...
          <section class="pt-page pt-page-5" data-id="contact">
            ...
            <button type="button" name="button" class="button" onclick="document.location.href='../admin/page-index2.php#home'">Kembali</button>            <div class="section-inner">
              <div class="section-inner">
                <div class="section-title-block">
                  <div class="section-title-wrapper">
                    <h2 class="section-title">Page Admin</h2>
                          ...
                          <tbody>
                            ...
                            while($data = mysqli_fetch_array($query)){
                              ...
                              <tr>
                                ...
                                <td>
                                    <a href='page-edit-ktg.php?id=<?= $data['id']?>' class="btn">Edit </a>
                                    <a href='delete-ktg.php?id=<?= $data['id']?>' class="btn"> Hapus</a>
                                </td>
                              </tr>
                              <?php } ?>
                          </tbody>
