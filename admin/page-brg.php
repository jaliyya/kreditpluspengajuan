              ...
              <div class="section-inner">
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6 subpage-block">
                    ...
                    <form id="contact-form" method="post" action="../admin/insert-brg.php">
                      ...
                      <div class="controls">
                        ...
                        <div class="form-group">
                          ...
                          <input  type="text" name="nm" class="form-control" placeholder="Iphone 13">
                        </div>

                        <div class="form-group">
                          <label>Harga Produk</label>
                          <input  type="number" name="hrg" class="form-control" onkeypress="return hanyaAngka(event)" placeholder="13.500.200">
                        </div>

                        <div class="form-group">
                          <label>Kode Barang</label>
                          <input type="text" name="kode_barang" class="form-control" placeholder="IP01">
                        </div>
                    ...
                    <div class="col-sm-6 col-md-6 subpage-block">
                      ...
                      <div class="controls">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" name="stk" class="form-control" onkeypress="return hanyaAngka(event)" placeholder="123">
                        </div>
                        ...
                        <input type="submit" class="button btn-send" name="tbh_brg" value="Tambah">
                      </div>
                    </form>
                  </div>
