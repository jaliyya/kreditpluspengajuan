              ...
              <div class="section-inner">
                <div class="section-title-block">
                  <div class="section-title-wrapper">
                    <h2 class="section-title">Page Kategori</h2>
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6 subpage-block">
                    ...
                    <form id="contact-form" method="post" action="../admin/insert-ktg.php">
                ...
                <div class="col-sm-6 col-md-6 subpage-block">
                  ...
                  <div class="form-group">
                    ...
                    <input  type="text" name="ktg" class="form-control" placeholder="Iphone 13">
                  </div>
                  ...
                  <input type="submit" class="button btn-send" name="tbh_ktg" value="Tambah">
                </div>
              </form>
            </div>
